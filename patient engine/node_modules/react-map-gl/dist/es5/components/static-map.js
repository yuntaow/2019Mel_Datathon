  ...
  (0, _createClass2["default"])(StaticMap, [{
    ...
    value: function _renderOverlays(dimensions) {
      ...
      return _react["default"].createElement(_mapContext["default"].Consumer, null, function (interactiveContext) {
        var context = (0, _objectSpread2["default"])({}, interactiveContext, {
          viewport: new _viewportMercatorProject["default"]((0, _objectSpread2["default"])({}, _this2.props, _this2.props.viewState, {
            width: width,
            height: height
          })),
          map: _this2._map,
